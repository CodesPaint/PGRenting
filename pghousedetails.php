<?php
  ...
  if(strpos($_SERVER['REQUEST_URI'], "op") !== false){
    
    if($_GET['op']=="sendcontact"){
      if(isset($_SESSION['cid'])){
        ...
        $sql = "select * from vendorgetintouch where vendorid='$vendorid'";
        $user = $db->query($sql);
        $result = $user->fetchAll(PDO::FETCH_ASSOC);
        $vendorphone="";
        $vendoremail="";
        $vendorcompany="";
        if(!empty($result)){
          $vendorcompany=$result[0]['company'];
          $vendorphone=$result[0]['mobile'];
          $vendoremail=$result[0]['email'];
        }
        $database->closeConnection();
        
        $msg="<b><?php $vendorcompany; ?></b><br/><p><h3><u>Contact Details</u></h3><br>";
        $msg1="Mobile No: <?php echo $vendorphone; ?><br/><br/>Email Address: <?php  echo $vendoremail; ?>";
        $message_body = $msg.$msg1;
        $subject="Vendor Contact Details";
        require_once 'sendmail.php';
        $result=sendMsg($useremail,$message_body,$subject);

      }else{
        echo "<script>alert('Can not see the details! Login First.');</script>";
      }
...
<section class="profil  py-4 ">
          ...
          <!-- Slider -->
             ...
             <div class="olanaklar-kutu">
                 ...
                 <div class="olanaklar">
                  ...
                  <h4 class="pb-3"><?php  echo $result[0]['company']; ?></h4>
                  
                  <ul class="yacht-info__list">    <!-- <ul class="vertical-align-mid"> --> 
                      <?php
                        if($result[0]['meals']=="Yes"){
                          ?>
                          <li> 
                          <i class="fa fa-cutlery"></i> &nbsp;
                          <span class="vertical-align-mid">Meals</span>
                      </li>
                          <?php
                        }
                      ?>
                      <?php
                        if($result[0]['television']=="Yes"){
                          ?>
                          <li>
                      ...
                      ?>
                      <?php
                        if($result[0]['furnished']=="Yes"){
                          ?>
                          <li>
                          <i class="fa fa-check-square-o"></i> &nbsp;
                          <span class="vertical-align-mid">Furnished</span>
                      </li>
                          <?php

                        }
                      ?>                      <?php
                        if($result[0]['parking']=="Yes"){

                          ?>
                          <li>
                          <i class="fa fa-check-square-o"></i> &nbsp;
                          <span class="vertical-align-mid">Parking</span>
                      </li>
                          <?php

                        }
                      ?>                      <?php
                        if($result[0]['security']=="Yes"){

                          ?>
                          <li>
                          <i class="fa fa-check-square-o"></i> &nbsp;
                          <span class="vertical-align-mid">Security</span>
                      </li>
                          <?php
 ...
 -->
                    <div class="olanaklar margin-top--22">
                     <h4 class="pb-3">PG House Policies</h4>
                     <p>
         ...
         <div class="col-md-4">
             <div class="card">
              ...
              <h4 class="product-title mb-2"></h4>
              <h4>&#8377 <?php echo $result[0]['rentpermonth']; ?></h4>   <!-- or &#x20A8 and &#8360 for RS -->
                 ...
                 <div class="card-body">
                     <span class="badge badge-warning"><?php echo $result[0]['company']  ?></span>
                     <p class="card-text"><?php  echo $result[0]['address']; ?></p>
                     <a style="display: grid;" href="pghousedetails.php?vid=<?php echo $result[0]['vendorid']; ?>&op=sendcontact" class="btn btn-success text-center">Check Contact Info. of Owner</a>
                     <!-- <span style="margin-left: 0%; color:red; font-weight: 500;">Cancellation Policy <i class="fa fa-info-circle"></i></span> -->
                     <br/><br/>
